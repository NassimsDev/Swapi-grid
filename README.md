...
| No e2e test suite | Scope decision | Functional verification was done manually in a real browser during development. Unit tests (14) cover the service's pagination/caching/retry logic and the grid's sorting/editing logic, with HTTP and the service mocked. |
